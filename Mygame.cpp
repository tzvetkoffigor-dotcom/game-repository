...
void PlayGame() {
    ...
    // ?? ����������� ���������� ����� �����������
    const float MAX_JUMP_HEIGHT = 150.0f;   // �������� ������ ������
    const float PLATFORM_SPACING = 110.0f;  // ?? ������ ���������� (���� 90)
    ...
    for (int i = 0; i < VISIBLE_PLATFORMS; i++) {
        ...
        if (i % 3 == 0) {
            ...
            platform.x = screenWidth - 50 - platform.width; // ������ �������
        }
    ...
    // ?? ���������������� ������ ��� ������� ����������
    const float MAX_JUMP_FORCE = -14.0f;    // �������� ���� ������
    ...
    while (!WindowShouldClose() && !gameOver) {
        ...
        if (platforms.back().y > -100) {
            ...
            // ?? �������������� ������� ��� ����� ��������
            switch (patternIndex) {
            case 0: newPlatform.x = 40; break;                       // ����
            case 1: newPlatform.x = screenWidth / 2 - 22; break;      // �����
            case 2: newPlatform.x = screenWidth - 40 - newPlatform.width; break; // �����
            case 3: newPlatform.x = 80; break;                       // ����-�����
            case 4: newPlatform.x = screenWidth - 120 - newPlatform.width; break; // �����-�����
            case 5: newPlatform.x = screenWidth / 2 - 22; break;      // �����
            }
